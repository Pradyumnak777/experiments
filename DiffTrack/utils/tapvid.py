...
class TAPVid(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        #frames_ori below are the original frames before resizing..
        return frames, trajs, visibles, query_points, frames_ori #visible indicates if each tracked point is visible in frame..
